        ...
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-4 lg:px-6">
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 className="text-3xl font-extrabold text-black dark:text-white sm:text-4xl">
              <span className="block px-2 text-[#3ea498]">
                Meet Our Heroes Behind the Scenes
                <br />
                <br />
              </span>
            </h2>
            ...
            <p className="text-justify">
              ...
              compassion are the driving forces behind our mission to deliver
              top-notch medical services. <br />
              <br />
              Paul Thistle has 29 years of full time medical missionary service
              in Zimbabwe, His commitment to improving healthcare access in
              rural areas has earned him widespread respect and admiration.
              Under his leadership, he has implemented innovative treatments and
              care protocols, significantly improving patient outcomes.
            </p>
