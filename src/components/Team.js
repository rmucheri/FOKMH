...
import { doctorl, karadoc } from "../assets";

const Paul = "https://thenewshawks.com/wp-content/uploads/2022/07/Karanda-Hospital-Medical-Director-Dr-Paul-Thistle-scaled.jpg"
...
<div class="max-w-sm p-6 mt-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
       <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"><span className="text-xl">{name} </span>{getContent()}</p>
       {content.length > 100 && (
        <button class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={toggleContent}>
