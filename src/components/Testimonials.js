...
function Testimonials() {
  return (
    <div>
     <section className="px-8 py-10 lg:py-8 bg-[#fffffd] shadow">
  <div className="container mx-auto">
    <h2 className="block antialiased tracking-normal font-sans font-semibold leading-[1.3] text-[#3ea498] mb-4 !text-2xl lg:!text-4xl">
    ...
    <div className="grid gap-8 grid-cols-1 lg:grid-cols-2">
      <div className="relative flex flex-col bg-clip-border bg-white text-gray-700 bg-gray-100/50 rounded-2xl p-6">
        <div className="relative bg-clip-border !mt-4 mx-4 rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none">
          <p className="block antialiased font-sans leading-relaxed text-gray-700 lg:mb-20 mb-4  font-bold">
    ...
    <div className="relative flex flex-col bg-clip-border bg-white text-gray-700 mt-8 bg-gray-100/50 text-center rounded-2xl p-6">
      <div className="relative bg-clip-border !mt-4 mx-4 rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none">
        <p className="block antialiased font-sans text-gray-700 mb-4  lg:!text-2xl max-w-4xl !leading-snug mx-auto font-bold">
